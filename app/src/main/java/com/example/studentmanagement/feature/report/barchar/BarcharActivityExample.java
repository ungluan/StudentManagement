package com.example.studentmanagement.feature.report.barchar;
...
public class BarcharActivityExample extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_barchar_example);
